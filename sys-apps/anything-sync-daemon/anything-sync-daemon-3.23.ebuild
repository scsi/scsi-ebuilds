...
HOMEPAGE="https://wiki.archlinux.org/index.php/Anything-sync-daemon https://github.com/graysky2/anything-sync-daemon"
...
src_install() {
	...
	gzip -9 asd.1
	install -g 0 -o 0 -Dm 0644 asd.1.gz "${D}/usr/share/man/man1/${PN}.1.gz"
	install -g 0 -o 0 -Dm 0644 asd.1.gz "${D}/usr/share/man/man1/asd.1.gz"
