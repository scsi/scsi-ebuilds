...
if [ "`id -u`" = 0 ]; then
	...
	alias gentooupdate='time (date;layman -S;eix-sync ;date;hostname;emerge -uDNv world;FEATURES="-distcc -distcc-pump" MAKEOPTS=-j`nproc` emerge -uDNv world;emerge @preserved-rebuild;emerge --depclean -pq)'
