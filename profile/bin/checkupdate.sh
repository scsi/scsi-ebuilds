...
add_data "smimui7" "https://www.androidfilehost.com/?w=files&flid=18823" " grep 'Folders'"
...
add_data "mi6-rom" "http://en.miui.com/download-326.html" "grep 'Version: '|awk '{print \$3}'"
add_data "mimax2-rom" "http://en.miui.com/download-328.html" "grep 'Version: '|awk '{print \$3}'"
add_data "rm4x-rom" "http://en.miui.com/download-321.html" "grep 'Version: '|awk '{print \$3}'"
add_data "mi2-rom" "http://en.miui.com/download-2.html" "grep 'Version: '|awk '{print \$3}'"
