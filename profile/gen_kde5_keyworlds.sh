...
(cd /usr/portage/official/;find kde-frameworks kde-plasma kde-apps -maxdepth 1 -mindepth 1 -type d)|sort|tee package.accept_keywords/kde-frameworks.accept_keywords
