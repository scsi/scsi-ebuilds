...
#SRC_URI="http://www.traco.hu/tools/5.4.4/forticlientsslvpn_linux_${PV}.tar"
SRC_URI="https://github.com/mcereda/forticlientsslvpn/tree/master/tarball/forticlientsslvpn_linux_${PV}.tar.gz"
